...
| React `@ds/react` + CSF3 Autodocs | 🟢 Fundação + W0–**W4 Dados & display** polish (2026-08-17) |
...
8. **Próximo:** polish scaffolds W5–W6 (substituir stubs por implementação DoD completa, onda a onda)  
   ...
   - **Próximo:** W5 Cards & app-cliente (audit → report → wait `aplicar`)
