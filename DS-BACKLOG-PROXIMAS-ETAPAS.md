...
| React `@ds/react` + CSF3 Autodocs | 🟢 Fundação + W0 + **W1 Formulários** polish (2026-08-17) |
...
8. **Próximo:** polish scaffolds W2–W6 (substituir stubs por implementação DoD completa, onda a onda)  
