...
| React `@ds/react` + CSF3 Autodocs | 🟢 Fundação + W0 + W1 + **W2 Feedback** polish (2026-08-17) |
...
8. **Próximo:** polish scaffolds W3–W6 (substituir stubs por implementação DoD completa, onda a onda)  
