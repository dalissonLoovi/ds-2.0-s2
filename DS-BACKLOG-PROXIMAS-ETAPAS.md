...
| React `@ds/react` + CSF3 Autodocs | 🟢 Fundação + W0–**W3 Nav/headers** polish (2026-08-17) |
...
8. **Próximo:** polish scaffolds W4–W6 (substituir stubs por implementação DoD completa, onda a onda)  
