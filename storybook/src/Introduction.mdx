...
| **Updated** | 2026-08-18T01:20:00.000Z |
| **Revision** | `2026-08-17-storybook-intro-changelog-copy` |
...
- **123 / 124** components ship as CSF3 Autodocs from `@ds/react` (Code Connect uses seed nodeIds).
- Seed MDX remains for: `CommentItem` — Figma-only annotation, not product UI.
