...
| **Updated** | 2026-09-14T14:30:00.000Z |
| **Revision** | `2026-09-14-inputtextarea-resting-label-body-large` |
...
- **127 / 130** components ship as CSF3 Autodocs from `@ds/react` (Code Connect uses seed nodeIds).
- Seed MDX remains for: `BrandLogo`, `CommentItem`, `PaymentMethodMark` — Figma-only annotation, not product UI.
