...
| **Updated** | 2026-08-26T22:45:00.000Z |
| **Revision** | `2026-08-26-button-visual-react-audit` |
...
- **125 / 128** components ship as CSF3 Autodocs from `@ds/react` (Code Connect uses seed nodeIds).
