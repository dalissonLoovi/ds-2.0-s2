...
| `icon` | INSTANCE_SWAP — local outline icon (default apps-outline); preferredValues: apps-outline, layout-grid-outline, category-outline, squares-outline, star-outline, credit-card-outline; stroke text/brand (disabled: text/placeholder) |
